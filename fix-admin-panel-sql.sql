-- FIX ADMIN PANEL SQL ISSUES
-- Run this in your Supabase SQL Editor to fix the admin panel

-- Update all admin functions to use glowyboy01@gmail.com instead of sihaaexpress@gmail.com
-- and fix table name case issues

-- 1. Update admin_delete_user function with correct email and table names
...
-- 2. Update admin_ban_user function
...
-- 3. Update admin_unban_user function
...
-- 4. Create function to get admin users (for special users like glowyboy01@gmail.com)
...
-- Check and fix table names consistency
...
SELECT 'Setup complete for glowyboy01@gmail.com admin!' as status;
